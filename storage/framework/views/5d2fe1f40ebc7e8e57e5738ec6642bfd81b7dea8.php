...
<div class="col-sm-9 block-main">
	<div class="block block-breadcrumb">
      <ul class="breadcrumb"> 
        ...
        <li><a href="<?php echo e(route('danh-muc', $rs->name)); ?>" title="<?php echo $rs->name; ?>"><?php echo $rs->name; ?></a></li>
        <li class="active">        
...
<div class="block-product block-block-title block-page">
	...
	<div class="block-share absolute">
		...
		<a  href="https://twitter.com/share?url=<?php echo e(url()->current()); ?>&amp;text=<?php echo $rsCate->name; ?>&amp;hashtags=baobihoahopphat" target="_blank" title="twitter" class="twitter"><i class="fa fa-twitter"></i></a>		
	</div>
