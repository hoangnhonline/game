...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('ads.index', ['object_id' => $object_id, 'object_type' => $object_type]) }}">banner</a></li>
  ...
  <section class="content">
    <a class="btn btn-default btn-sm " href="{{ route('ads.index', ['object_id' => $object_id, 'object_type' => $object_type]) }}" style="margin-bottom:5px">Quay lại</a>
    <form role="form" method="POST" action="{{ route('ads.update') }}">
    <div class="row">
      <!-- left column -->
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="{{ route('ads.index', ['object_id' => $object_id, 'object_type' => $object_type])}}">Hủy</a>
            </div>
