...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <a class="btn btn-primary btn-sm" href="{{ route('child', [$loaiSp->slug, $detail->slug] ) }}" target="_blank" style="margin-top:-6px"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>
    <div class="row">
      <!-- left column -->
        ...
        <div class="box box-primary">
          ...
          <form role="form" method="POST" action="{{ route('cate.update') }}">
            ...
            <div class="box-body">
              ...
              <div class="col-md-12">
                <div class="checkbox">
                   <label><input type="checkbox" name="is_hot" value="1" {{ $detail->is_hot == 1 ? "checked" : "" }}> <span style="color:blue"> HOT </span></label>
                </div>
             </div>
              <div class="form-group">
                <label>Ẩn/hiện</label>
